...
export const IndexAddButton: FC<{ isVisible: boolean; openModal: (visible: boolean) => void }> = ({ isVisible, openModal }) => {
  return isVisible ? (
...
export const IndexTableRow: FC<{ children: ReactNode } & React.ComponentProps<"tr">> = ({ children, ...props }) => {
  return <tr {...props}>{children}</tr>;
};

export const IndexTableActionCell: FC<{ children: ReactNode } & React.ComponentProps<"td">> = ({ children, ...props }) => {
  return (
