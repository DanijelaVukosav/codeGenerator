...
import {
    getFilterCriteriaArray,
    removeSelectedFilterCriteria,
    validateFilteringSubmitData
} from './utilsFunction';
...
export const FilterContainer: FC<FilterContainerProps> = ({
    ...
    const removeFilter = (removeFilterCriteria: FilterCriteria) => {
        ...
        const remainingFilters = removeSelectedFilterCriteria(
    ...
    const clearFilterForm = () => {
        ...
        const resetValues: Record<
            string,
            { value: CustomAnyType; operation?: FilterCriteriaOperator }
        > = {};
    ...
    const tableFilterFields = useMemo(() => {
        return tableColumnsConfig.filter(
            (columnSettings: TableColumnType) => columnSettings.hasFilter
        );
    }, [tableColumnsConfig]);
    ...
    return (
        <React.Fragment>
            ...
            <ChosenFilterCriteriaContainer
                chosenFilterCriteria={chosenFilterCriteria}
                visible={!isExpandedFilterContainer}
