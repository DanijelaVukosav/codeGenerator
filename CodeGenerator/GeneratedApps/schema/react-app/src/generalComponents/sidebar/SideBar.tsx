...
ability.can("KORISNICI_READ", "KORISNICI_READ") &&
sideBarLinks.push({
key: "korisnici",
path: APPLICATION_ROUTES.KORISNICI,
});
ability.can("PROIZVODI_READ", "PROIZVODI_READ") &&
sideBarLinks.push({
key: "proizvodi",
path: APPLICATION_ROUTES.PROIZVODI,
});
ability.can("NARUDZBE_READ", "NARUDZBE_READ") &&
sideBarLinks.push({
key: "narudzbe",
path: APPLICATION_ROUTES.NARUDZBE,
});
